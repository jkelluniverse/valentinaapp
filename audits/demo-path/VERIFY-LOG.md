...
Last run: 2026-09-19T23:22:30.146Z

# C30-DEMO-PATH verify — 2026-09-19T23:22:25.812Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=4CE5ZAK4
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "4CE5ZAK4"
- ✓ EN — /signup renders in EN, carries ref="4CE5ZAK4" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=V2DP2X7K
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|4CE5ZAK4
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|4CE5ZAK4
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=V2A8HDE3&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "V2A8HDE3"
- ✓ ES — /signup renders in ES, carries ref="V2A8HDE3" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=HMTJ9XFQ&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|V2A8HDE3
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|V2A8HDE3
