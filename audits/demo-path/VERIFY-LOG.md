...
Last run: 2026-09-18T16:25:27.816Z

# C30-DEMO-PATH verify — 2026-09-18T16:25:22.694Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=QHRARYKE
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "QHRARYKE"
- ✓ EN — /signup renders in EN, carries ref="QHRARYKE" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=MA7WBZE8
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|QHRARYKE
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|QHRARYKE
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=FQ2QNENJ&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "FQ2QNENJ"
- ✓ ES — /signup renders in ES, carries ref="FQ2QNENJ" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=XJYF68CK&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|FQ2QNENJ
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|FQ2QNENJ
