...
Last run: 2026-09-16T16:28:11.419Z

# C30-DEMO-PATH verify — 2026-09-16T16:28:06.274Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=78ZVWFQC
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "78ZVWFQC"
- ✓ EN — /signup renders in EN, carries ref="78ZVWFQC" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=56ADDGEW
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|78ZVWFQC
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|78ZVWFQC
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=MBHYM3N8&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "MBHYM3N8"
- ✓ ES — /signup renders in ES, carries ref="MBHYM3N8" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=PYCMDKD6&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|MBHYM3N8
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|MBHYM3N8
