...
Last run: 2026-09-19T20:59:00.338Z

# C30-DEMO-PATH verify — 2026-09-19T20:58:56.071Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=DS8JHM6Y
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "DS8JHM6Y"
- ✓ EN — /signup renders in EN, carries ref="DS8JHM6Y" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=N5DE9H92
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|DS8JHM6Y
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|DS8JHM6Y
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=589CHAZY&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "589CHAZY"
- ✓ ES — /signup renders in ES, carries ref="589CHAZY" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=JSEZ9DK9&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|589CHAZY
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|589CHAZY
