...
Last run: 2026-09-19T20:18:24.040Z

# C30-DEMO-PATH verify — 2026-09-19T20:18:19.614Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=ERB8TBK2
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "ERB8TBK2"
- ✓ EN — /signup renders in EN, carries ref="ERB8TBK2" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=CAB3CDXZ
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|ERB8TBK2
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|ERB8TBK2
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=GGWQ3CP2&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "GGWQ3CP2"
- ✓ ES — /signup renders in ES, carries ref="GGWQ3CP2" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=Z3NRSRGA&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|GGWQ3CP2
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|GGWQ3CP2
