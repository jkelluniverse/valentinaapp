...
Last run: 2026-09-22T22:12:56.140Z

# C30-DEMO-PATH verify — 2026-09-22T22:12:50.736Z
...
- ✓ EN — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=Q45PZ9QX
- ✓ EN — thanks screen displays the referral code, in EN, law-2 clean — displayed "Q45PZ9QX"
- ✓ EN — /signup renders in EN, carries ref="Q45PZ9QX" untransformed, law-2 clean
- ✓ EN — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-en&email=c30-founder-en%40fixture.test&code=MM2AP26P
...
- ✓ EN — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|Q45PZ9QX
- ✓ EN — the referrer stays LEAD and owns that code — LEAD|Q45PZ9QX
...
- ✓ ES — /join POST (no-JS server action) lands on the thanks screen with a code — 303 → /join/thanks?code=DT66MQDQ&lang=es
- ✓ ES — thanks screen displays the referral code, in ES, law-2 clean — displayed "DT66MQDQ"
- ✓ ES — /signup renders in ES, carries ref="DT66MQDQ" untransformed, law-2 clean
- ✓ ES — /signup POST provisions and lands on the welcome screen — 303 → /signup/welcome?slug=c30-demo-es&email=c30-founder-es%40fixture.test&code=X2TDGTC3&lang=es
...
- ✓ ES — A2: the founder's stored referredByCode IS the displayed string, byte-equal — SIGNED_UP|DT66MQDQ
- ✓ ES — the referrer stays LEAD and owns that code — LEAD|DT66MQDQ
