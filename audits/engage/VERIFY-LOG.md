...
Run: 2026-09-14T16:59:19.142Z · `npx tsx audits/engage/verify.ts` against the BUILT app on :3129
...
- ✓ with NO switch row at all the gate is CLOSED by default — {"ok":true,"at":"2026-09-14T16:59:17.919Z","only":"engage","engage":"considered=7 sent=0 skipped=6 suppressed=1 unconfigured=0 gate=closed paused=false configured=false"}
...
- ✓ with the gate OPEN but the global pause ON the tick still sends nothing — {"ok":true,"at":"2026-09-14T16:59:18.009Z","only":"engage","engage":"considered=6 sent=0 skipped=6 suppressed=0 unconfigured=0 gate=open paused=true configured=false"}
...
- ✓ a full tick with no email credential returns 200 and throws nothing — {"ok":true,"at":"2026-09-14T16:59:18.068Z","only":"engage","engage":"considered=6 sent=0 skipped=0 suppressed=0 unconfigured=6 gate=open paused=false configured=false"}
...
- ✓ the welcome was anchored on conversion, not on capture — 2026-09-15T16:58:16.431Z
...
- ✓ one click sets unsubscribedAt — status 200, unsubscribedAt 2026-09-14T16:59:18.484Z
...
- ✓ the queue view renders what is due next (due now AND upcoming) — due now engage-queue-probe@fixture.test event-lead / thanks en 2026-09-14 16:58 nothing yet upcoming engage-queue-probe@fixture
