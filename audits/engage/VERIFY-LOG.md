...
Run: 2026-09-17T17:32:41.177Z · `npx tsx audits/engage/verify.ts` against the BUILT app on :3129
...
- ✓ with NO switch row at all the gate is CLOSED by default — {"ok":true,"at":"2026-09-17T17:32:39.858Z","only":"engage","engage":"considered=7 sent=0 skipped=6 suppressed=1 unconfigured=0 gate=closed paused=false configured=false"}
...
- ✓ with the gate OPEN but the global pause ON the tick still sends nothing — {"ok":true,"at":"2026-09-17T17:32:39.954Z","only":"engage","engage":"considered=6 sent=0 skipped=6 suppressed=0 unconfigured=0 gate=open paused=true configured=false"}
...
- ✓ a full tick with no email credential returns 200 and throws nothing — {"ok":true,"at":"2026-09-17T17:32:40.013Z","only":"engage","engage":"considered=6 sent=0 skipped=0 suppressed=0 unconfigured=6 gate=open paused=false configured=false"}
...
- ✓ the welcome was anchored on conversion, not on capture — 2026-09-18T17:31:38.256Z
...
- ✓ one click sets unsubscribedAt — status 200, unsubscribedAt 2026-09-17T17:32:40.370Z
...
- ✓ the queue view renders what is due next (due now AND upcoming) — due now engage-queue-probe@fixture.test event-lead / thanks en 2026-09-17 17:31 nothing yet upcoming engage-queue-probe@fixture
