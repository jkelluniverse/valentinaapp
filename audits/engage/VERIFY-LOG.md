...
Run: 2026-09-14T19:42:28.270Z · `npx tsx audits/engage/verify.ts` against the BUILT app on :3129
...
- ✓ with NO switch row at all the gate is CLOSED by default — {"ok":true,"at":"2026-09-14T19:42:27.191Z","only":"engage","engage":"considered=7 sent=0 skipped=6 suppressed=1 unconfigured=0 gate=closed paused=false configured=false"}
...
- ✓ with the gate OPEN but the global pause ON the tick still sends nothing — {"ok":true,"at":"2026-09-14T19:42:27.268Z","only":"engage","engage":"considered=6 sent=0 skipped=6 suppressed=0 unconfigured=0 gate=open paused=true configured=false"}
...
- ✓ a full tick with no email credential returns 200 and throws nothing — {"ok":true,"at":"2026-09-14T19:42:27.311Z","only":"engage","engage":"considered=6 sent=0 skipped=0 suppressed=0 unconfigured=6 gate=open paused=false configured=false"}
...
- ✓ the welcome was anchored on conversion, not on capture — 2026-09-15T19:41:25.677Z
...
- ✓ one click sets unsubscribedAt — status 200, unsubscribedAt 2026-09-14T19:42:27.602Z
...
- ✓ the queue view renders what is due next (due now AND upcoming) — due now engage-queue-probe@fixture.test event-lead / thanks en 2026-09-14 19:41 nothing yet upcoming engage-queue-probe@fixture
