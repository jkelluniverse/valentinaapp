...
Run: 2026-09-12T20:44:52.918Z · `npx tsx audits/settings-i18n-verify.ts` against the BUILT app on :3131
Database: postgresql://postgres:***@localhost:5432/veritas_scratch

# task #78 — /practitioner/settings i18n verify — 2026-09-12T20:44:50.869Z
...
- ✓ EVERY English string is byte-identical (whitespace-normalised) to the pre-pass page — an i18n MOVE, not a copy rewrite — 85 strings matched against the pre-pass commit (939a663)
