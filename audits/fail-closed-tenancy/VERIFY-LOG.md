# C26-FAIL-CLOSED-TENANCY verify — 2026-09-12T21:59:00.995Z
...
- ✓ a real ACTIVE non-default practice exists (real signup service) — tenant B = cmtyxgf28000110rrdw8zei0a
...
- ✓ V5 — the healthy booking still completes on B's host and the Lead is stamped tenant B — final url /book/confirmed?t=cmtyxgmj00002uk5raedwsfil.4HK2HfFMQiZXCtskliWgSCm5fejF74qT8JJ6uIn0vgY · Lead.tenantId = cmtyxgf28000110rrdw8zei0a
- ✓ V5/V4 — and its two notification emails reached the SINK — proving phase 1's zero-email assertion had a working instrument — sink: t26-probe-b@fixture.test · t26-lead-healthy@fixture.test
...
- ✓ V3 — the STATIC front door is resolution-INDEPENDENT: under failure it served byte-identical content to the healthy request, so the failure changed nothing about whose identity renders — healthy 37244b === failure 37244b: true
