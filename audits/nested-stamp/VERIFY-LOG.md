...
Run: 2026-09-19T22:39:54.930Z · `npx tsx audits/nested-stamp-verify.ts`
...
# C24-NESTED-STAMP verify — 2026-09-19T22:39:52.177Z
...
- ✓ A2 CORRECTED: it is NOT the only place a tenant is stamped — call sites stamp explicitly for the OUT-of-request path — 15 file(s), e.g. audits/c12x-ai-pass/run3-patch01.ts, audits/capture/verify.ts, audits/engage/verify.ts
...
- ✓ it records exactly the rows it stamped, per table (this is what makes it reversible) — Chapter=1 LogEntry=68
