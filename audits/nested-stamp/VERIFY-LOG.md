...
Run: 2026-09-16T23:44:31.349Z · `npx tsx audits/nested-stamp-verify.ts`
...
# C24-NESTED-STAMP verify — 2026-09-16T23:44:27.626Z
...
- ✓ A1 CORRECTED: outside the acceptance harnesses the repo contains ZERO nested relation writes on scoped models — 488 files scanned against 43 schema relation fields · hits=0
...
- ✓ it records exactly the rows it stamped, per table (this is what makes it reversible) — Chapter=1 LogEntry=24
