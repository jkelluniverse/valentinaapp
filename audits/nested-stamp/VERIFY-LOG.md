...
Run: 2026-09-18T16:44:09.950Z · `npx tsx audits/nested-stamp-verify.ts`
...
# C24-NESTED-STAMP verify — 2026-09-18T16:44:06.771Z
...
- ✓ A1 CORRECTED: outside the acceptance harnesses the repo contains ZERO nested relation writes on scoped models — 491 files scanned against 44 schema relation fields · hits=0
...
- ✓ it records exactly the rows it stamped, per table (this is what makes it reversible) — Chapter=1 LogEntry=40
