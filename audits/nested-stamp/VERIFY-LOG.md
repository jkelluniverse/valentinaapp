...
Run: 2026-09-14T16:59:28.808Z · `npx tsx audits/nested-stamp-verify.ts`
...
# C24-NESTED-STAMP verify — 2026-09-14T16:59:25.369Z
...
- ✓ A1 CORRECTED: outside the acceptance harnesses the repo contains ZERO nested relation writes on scoped models — 480 files scanned against 43 schema relation fields · hits=0
...
- ✓ it records exactly the rows it stamped, per table (this is what makes it reversible) — Chapter=1 LogEntry=8
