...
export default async function SpaceHome({
  ...
  searchParams: { type?: string; saved?: string; deleted?: string; error?: string };
}) {
  ...
  const banner = searchParams.saved ? BANNERS.saved : searchParams.deleted ? BANNERS.deleted : null;
